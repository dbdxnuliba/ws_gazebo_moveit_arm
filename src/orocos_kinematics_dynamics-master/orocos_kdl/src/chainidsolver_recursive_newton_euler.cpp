...
namespace KDL{
    ...
    {
        std::cout<<"[ChainIdSolver_RNE::CartToJnt],nj:"<<nj<<"\t,chain.getNrOfJoints():"<<chain.getNrOfJoints()<<std::endl;
        std::cout<<"[ChainIdSolver_RNE::CartToJnt],ns:"<<ns<<"\t,chain.getNrOfSegments():"<<chain.getNrOfSegments()<<std::endl;
