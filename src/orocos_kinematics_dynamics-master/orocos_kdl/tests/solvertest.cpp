...
void SolverTest::ExternalWrenchEstimatorTest()
{
    ...
    for (unsigned int i = 0; i < jnt_pos.size(); i++)
    {
     ...
     printf("%f          %f      %f       %f     %f       %f      %f    \n",ext_torque_estimated(0),ext_torque_estimated(1),ext_torque_estimated(2),ext_torque_estimated(3),ext_torque_estimated(4),ext_torque_estimated(5),ext_torque_estimated(6));
